...
10. Faker (генерация данных для полей)
11. Allure (для создания отчетов о проведенном тестировании)
12. REST Assured (для отправки запросов на API)
13. Postman (для проверки отправки запросов на API)
...
- Написание автотестов для формы по оформлению покупки тура в кредит по дебетовой карте - 10 часа
